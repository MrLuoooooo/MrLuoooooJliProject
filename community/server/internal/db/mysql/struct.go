...
type Notification struct {
	BaseModel
	UserID    uint   `gorm:"index;not null" json:"user_id"`
	FromID    uint   `gorm:"default:0" json:"from_id"`
	Type      int    `gorm:"default:0" json:"type"`       // 1=评论回复 2=点赞 3=关注 4=系统
	TargetID  uint   `gorm:"default:0" json:"target_id"`  // 关联的帖子/评论ID
...
type PasswordReset struct {
	...
	Email     string `gorm:"column:email;size:100;index"`
	Token     string `gorm:"column:token;size:64;uniqueIndex"`
